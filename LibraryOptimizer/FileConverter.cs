...
public class FileConverter
{
    ...
    public FileConverter(string commandInputFilePath, double bitRate, LibraryOptmizer.LibraryOptimizer optimizerSettings) : this(commandInputFilePath, optimizerSettings)
    {
        ...
        else
        {
            ...
            {
                _encodeAv1Command = $"ffmpeg -hwaccel qsv -i '{commandInputFilePath}' -map 0:v:0 -map 0:a? -map 0:s? -c:v av1_qsv -global_quality 18 -preset 1 -c:a copy -c:s copy -analyzeduration 1000000 -map_metadata 0 -map_chapters 0 '{_commandOutputFile}'";
            }
